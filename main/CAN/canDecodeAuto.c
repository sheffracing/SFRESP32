...
uint8_t tLastTaskTime1msContactorDriver = 0;
uint8_t tMaxTaskTime1msContactorDriver = 0;
uint8_t tLastTaskTime100msContactorDriver = 0;
uint8_t tMaxTaskTime100msContactorDriver = 0;
uint8_t tLastTaskTimeBGContactorDriver = 0;
uint8_t tMaxTaskTimeBGContactorDriver = 0;
uint16_t tSincePowerUpContactorDriver = 0;
uint8_t NLastResetReasonContactorDriver = 0;
...
uint32_t tSinceMCUStatusContactorDriver = 5000;
bool BMCUStatusContactorDriverInError = true;
...
esp_err_t ESPControlRx(CAN_frame_t stFrame)
{
    ...
    */
    if (stFrame.byDLC != 2) return ESP_ERR_INVALID_SIZE;
...
esp_err_t MCUStatusContactorDriverRx(CAN_frame_t stFrame)
{
    /*
    *===========================================================================
    *   MCUStatusContactorDriverRx
    *   Message: MCUStatusContactorDriver (0x1B)
    *   Description: MCU Status Message
    *   Takes:   stFrame: The CAN frame to decode
    *   Returns: ESP_OK if successful, error code if not.
    *   Autogenerated by decodeCAN.py
    */
    if (stFrame.byDLC != 8) return ESP_ERR_INVALID_SIZE;
    if (stFrame.dwID != 0x1B) return ESP_ERR_INVALID_ARG;

    tSinceMCUStatusContactorDriver = 0;

    /* Standard Signals */
    tLastTaskTime1msContactorDriver = (uint8_t)((float)(((stFrame.abData[0] >> 0) & 0xFF)) * 50.0f);
    tMaxTaskTime1msContactorDriver = (uint8_t)((float)(((stFrame.abData[1] >> 0) & 0xFF)) * 50.0f);
    tLastTaskTime100msContactorDriver = (uint8_t)((float)(((stFrame.abData[2] >> 0) & 0xFF)) * 500.0f);
    tMaxTaskTime100msContactorDriver = (uint8_t)((float)(((stFrame.abData[3] >> 0) & 0xFF)) * 500.0f);
    tLastTaskTimeBGContactorDriver = (uint8_t)((float)(((stFrame.abData[4] >> 0) & 0xFF)) * 500.0f);
    tMaxTaskTimeBGContactorDriver = (uint8_t)((float)(((stFrame.abData[5] >> 0) & 0xFF)) * 500.0f);
    tSincePowerUpContactorDriver = (uint16_t)((float)((((uint16_t)((stFrame.abData[6] >> 0) & 0xFF)) << 4) | ((uint16_t)((stFrame.abData[7] >> 4) & 0xF))) * 4.0f);
    NLastResetReasonContactorDriver = (uint8_t)(((stFrame.abData[7] >> 0) & 0xF));
    return ESP_OK;
}
...
esp_err_t MCUStatusContactorDriverTx(twai_node_handle_t stCANBus)
{
    /*
    *===========================================================================
    *   MCUStatusContactorDriverTx
    *   Encodes and Transmits Message: MCUStatusContactorDriver (0x1B)
    *   Uses global signal variables.
    *   Takes:   stCANBus: Handle to CAN bus to transmit on
    *   Returns: ESP_OK if successful, error code if not.
    *   Autogenerated by decodeCAN.py
    */
    ...
    stFrame.abData[0] |= (uint8_t)(((((uint32_t)(((float)tLastTaskTime1msContactorDriver) / 50.0f) & 0xFF) >> 0) & 0xFF) << 0);
    stFrame.abData[1] |= (uint8_t)(((((uint32_t)(((float)tMaxTaskTime1msContactorDriver) / 50.0f) & 0xFF) >> 0) & 0xFF) << 0);
    stFrame.abData[2] |= (uint8_t)(((((uint32_t)(((float)tLastTaskTime100msContactorDriver) / 500.0f) & 0xFF) >> 0) & 0xFF) << 0);
    stFrame.abData[3] |= (uint8_t)(((((uint32_t)(((float)tMaxTaskTime100msContactorDriver) / 500.0f) & 0xFF) >> 0) & 0xFF) << 0);
    stFrame.abData[4] |= (uint8_t)(((((uint32_t)(((float)tLastTaskTimeBGContactorDriver) / 500.0f) & 0xFF) >> 0) & 0xFF) << 0);
    stFrame.abData[5] |= (uint8_t)(((((uint32_t)(((float)tMaxTaskTimeBGContactorDriver) / 500.0f) & 0xFF) >> 0) & 0xFF) << 0);
    stFrame.abData[6] |= (uint8_t)(((((uint32_t)(((float)tSincePowerUpContactorDriver) / 4.0f) & 0xFFF) >> 4) & 0xFF) << 0);
    stFrame.abData[7] |= (uint8_t)(((((uint32_t)(((float)tSincePowerUpContactorDriver) / 4.0f) & 0xFFF) >> 0) & 0xF) << 4);
    stFrame.abData[7] |= (uint8_t)(((((uint32_t)NLastResetReasonContactorDriver & 0xF) >> 0) & 0xF) << 0);
...
esp_err_t DashDataRx(CAN_frame_t stFrame)
{
    ...
    *   Autogenerated by decodeCAN.py
    */
    if (stFrame.byDLC != 1) return ESP_ERR_INVALID_SIZE;
...
esp_err_t IMDDataRx(CAN_frame_t stFrame)
{
    ...
    *   Autogenerated by decodeCAN.py
    */
    if (stFrame.byDLC != 5) return ESP_ERR_INVALID_SIZE;
...
esp_err_t SetERPMRx(CAN_frame_t stFrame)
{
    ...
    *   Autogenerated by decodeCAN.py
    */
    if (stFrame.byDLC != 4) return ESP_ERR_INVALID_SIZE;
...
esp_err_t DynoTempsRawRx(CAN_frame_t stFrame)
{
    ...
    *   Autogenerated by decodeCAN.py
    */
    if (stFrame.byDLC != 6) return ESP_ERR_INVALID_SIZE;
...
{
    tSinceCellVoltages += 1; if (tSinceCellVoltages > 40) BCellVoltagesInError = TRUE; else BCellVoltagesInError = FALSE;
    tSinceSetRelCurrent += 1; if (tSinceSetRelCurrent > 5) BSetRelCurrentInError = TRUE; else BSetRelCurrentInError = FALSE;
    tSinceFRTireTemp1 += 1; if (tSinceFRTireTemp1 > 150) BFRTireTemp1InError = TRUE; else BFRTireTemp1InError = FALSE;
    tSinceFRTireTemp2 += 1; if (tSinceFRTireTemp2 > 150) BFRTireTemp2InError = TRUE; else BFRTireTemp2InError = FALSE;
    tSinceFRTireTemp3 += 1; if (tSinceFRTireTemp3 > 150) BFRTireTemp3InError = TRUE; else BFRTireTemp3InError = FALSE;
    tSinceFRTireTemp4 += 1; if (tSinceFRTireTemp4 > 150) BFRTireTemp4InError = TRUE; else BFRTireTemp4InError = FALSE;
    tSinceFLTireTemp1 += 1; if (tSinceFLTireTemp1 > 150) BFLTireTemp1InError = TRUE; else BFLTireTemp1InError = FALSE;
    tSinceFLTireTemp2 += 1; if (tSinceFLTireTemp2 > 150) BFLTireTemp2InError = TRUE; else BFLTireTemp2InError = FALSE;
    tSinceFLTireTemp3 += 1; if (tSinceFLTireTemp3 > 150) BFLTireTemp3InError = TRUE; else BFLTireTemp3InError = FALSE;
    tSinceFLTireTemp4 += 1; if (tSinceFLTireTemp4 > 150) BFLTireTemp4InError = TRUE; else BFLTireTemp4InError = FALSE;
    tSinceRRTireTemp1 += 1; if (tSinceRRTireTemp1 > 150) BRRTireTemp1InError = TRUE; else BRRTireTemp1InError = FALSE;
    tSinceRRTireTemp2 += 1; if (tSinceRRTireTemp2 > 150) BRRTireTemp2InError = TRUE; else BRRTireTemp2InError = FALSE;
    tSinceRRTireTemp3 += 1; if (tSinceRRTireTemp3 > 150) BRRTireTemp3InError = TRUE; else BRRTireTemp3InError = FALSE;
    tSinceRRTireTemp4 += 1; if (tSinceRRTireTemp4 > 150) BRRTireTemp4InError = TRUE; else BRRTireTemp4InError = FALSE;
    tSinceRLTireTemp1 += 1; if (tSinceRLTireTemp1 > 150) BRLTireTemp1InError = TRUE; else BRLTireTemp1InError = FALSE;
    tSinceRLTireTemp2 += 1; if (tSinceRLTireTemp2 > 150) BRLTireTemp2InError = TRUE; else BRLTireTemp2InError = FALSE;
    tSinceRLTireTemp3 += 1; if (tSinceRLTireTemp3 > 150) BRLTireTemp3InError = TRUE; else BRLTireTemp3InError = FALSE;
    tSinceRLTireTemp4 += 1; if (tSinceRLTireTemp4 > 150) BRLTireTemp4InError = TRUE; else BRLTireTemp4InError = FALSE;
    tSinceTargetIqInfo += 1; if (tSinceTargetIqInfo > 125) BTargetIqInfoInError = TRUE; else BTargetIqInfoInError = FALSE;
    tSinceERPM_DUTY_VOLTAGE += 1; if (tSinceERPM_DUTY_VOLTAGE > 125) BERPM_DUTY_VOLTAGEInError = TRUE; else BERPM_DUTY_VOLTAGEInError = FALSE;
    tSinceAC_DC_current += 1; if (tSinceAC_DC_current > 125) BAC_DC_currentInError = TRUE; else BAC_DC_currentInError = FALSE;
    tSinceTemperatures += 1; if (tSinceTemperatures > 125) BTemperaturesInError = TRUE; else BTemperaturesInError = FALSE;
    tSinceFOC += 1; if (tSinceFOC > 125) BFOCInError = TRUE; else BFOCInError = FALSE;
    tSinceInverter_MISC += 1; if (tSinceInverter_MISC > 125) BInverter_MISCInError = TRUE; else BInverter_MISCInError = FALSE;
    tSinceMinMaxAcCurrent += 1; if (tSinceMinMaxAcCurrent > 125) BMinMaxAcCurrentInError = TRUE; else BMinMaxAcCurrentInError = FALSE;
    tSinceMinMaxDcCurrent += 1; if (tSinceMinMaxDcCurrent > 125) BMinMaxDcCurrentInError = TRUE; else BMinMaxDcCurrentInError = FALSE;
    tSinceCellStats1 += 1; if (tSinceCellStats1 > 40) BCellStats1InError = TRUE; else BCellStats1InError = FALSE;
    tSinceCellStats2 += 1; if (tSinceCellStats2 > 40) BCellStats2InError = TRUE; else BCellStats2InError = FALSE;
    tSinceCellStats3 += 1; if (tSinceCellStats3 > 40) BCellStats3InError = TRUE; else BCellStats3InError = FALSE;
    tSinceCellStats4 += 1; if (tSinceCellStats4 > 40) BCellStats4InError = TRUE; else BCellStats4InError = FALSE;
}
